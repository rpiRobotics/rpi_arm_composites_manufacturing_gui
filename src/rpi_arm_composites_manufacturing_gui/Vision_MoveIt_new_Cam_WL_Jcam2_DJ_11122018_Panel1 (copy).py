...
def main():
    ...
    rot = np.array([[-0.9971185,  0.0071821,  0.0755188], [ 0.0056502,  0.9997743, -0.0204797], [-0.0756488, -0.0199939, -0.9969341]])
...
#    while ((du>10) | (dv>10) | (pose_target2.p[2] > 0.172)):    #try changing du and dv to lower values(number of iterations increases)
    while ((du>1) | (dv>1) and (iteration<150)):    #try changing du and dv to lower values(number of iterations increases)
...
#            print "Average Reprojectoin error: ",np.mean(imgPoints_ground-reprojected_imagePoints_ground_2, axis=0)
            ...
            cv2.waitKey(1)
            #Save
            filename_image = "/home/rpi-cats/Desktop/DJ/Code/Images/Acquisition_"+str(t1)+"_"+str(iteration)+".jpg"
...
#            f_handle.close()
    ...
    filename_data = "/home/rpi-cats/Desktop/DJ/Code/Data/Data_"+str(t1)+".mat"
    scipy.io.savemat(filename_data, mdict={'du_array':du_array, 'dv_array':dv_array, 'dx_array':dx_array})
	
	
    #Saving force data to file
    filename_force_data = "/home/rpi-cats/Desktop/DJ/Code/Data/Data_force_"+str(t1)+".mat"
